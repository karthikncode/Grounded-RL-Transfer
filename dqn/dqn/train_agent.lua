...
cmd:option('-test_mode', false, 'run in test mode (no training)') 
...
--- General setup.
local game_env, game_actions, agent, opt, game_num, level_num = setup(opt)
...
local screen, reward, terminal = game_env:newGame(game_num, level_num)
...
while step < opt.steps do
    ...
    if not terminal then
        ...
        screen, reward, terminal = game_env:newGame(game_num, level_num)
    end
