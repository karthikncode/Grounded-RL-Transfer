...
function setup(_opt)
    ...
    local game_num = tonumber(opt.game_num)
    local level_num = tonumber(opt.level_num)
    local screen, reward, terminal = gameEnv:newGame(game_num, level_num)
    ...
    return gameEnv, gameActions, agent, opt, game_num, level_num
end
